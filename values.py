...
class Value:
    ...
    def added_to(self, other): return None, self.illegal_operation(other)
    def subbed_by(self, other): return None, self.illegal_operation(other)
    def multed_by(self, other): return None, self.illegal_operation(other)
    def dived_by(self, other): return None, self.illegal_operation(other)
    def powed_by(self, other): return None, self.illegal_operation(other)
    def get_comparison_eq(self, other): return None, self.illegal_operation(other)
    def get_comparison_ne(self, other): return None, self.illegal_operation(other)
    def get_comparison_lt(self, other): return None, self.illegal_operation(other)
    def get_comparison_gt(self, other): return None, self.illegal_operation(other)
    def get_comparison_lte(self, other): return None, self.illegal_operation(other)
    def get_comparison_gte(self, other): return None, self.illegal_operation(other)
    def anded_by(self, other): return None, self.illegal_operation(other)
    def ored_by(self, other): return None, self.illegal_operation(other)
    def notted(self): return None, self.illegal_operation()
    
    def execute(self, args): return None, self.illegal_operation()
    def get_attr(self, name_tok): return None, self.illegal_operation()
    def set_attr(self, name_tok, value): return None, self.illegal_operation()

    def get_element_at(self, index): return None, self.illegal_operation()
    def set_element_at(self, index, value): return None, self.illegal_operation()
...
class Class(BaseFunction):
    ...
    def get_attr(self, name_tok):
        ...
        if method:
            return method.copy().set_context(self.context).set_pos(name_tok.pos_start, name_tok.pos_end), None
...
class BoundMethod(BaseFunction):
    ...
    def execute(self, args):
        ...
        if len(original_arg_names) == 0 or original_arg_names[0] != 'self':
            return res.failure(RTError(
                self.function_to_bind.pos_start, self.function_to_bind.pos_end,
        ...
        res.register(self.function_to_bind.check_and_populate_args(
    ...
    def copy(self):
        return BoundMethod(self.name, self.function_to_bind.copy(), self.instance).set_context(self.context).set_pos(self.pos_start, self.pos_end)
